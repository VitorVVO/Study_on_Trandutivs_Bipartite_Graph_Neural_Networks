...
# try:
#     os.makedirs("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/")
# except OSError as e:
...
#     try:
#         os.makedirs("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i))
#     except OSError as e:
#         if e.errno != errno.EEXIST:
#             raise

#     df_list[i][0].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_acc.pkl") # acuracia
#     df_list[i][1].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_pre.pkl") # precision
#     df_list[i][2].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_rec.pkl") # recall
#     df_list[i][3].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_f1.pkl")  # f1-score
#     df_list[i][4].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_sup.pkl") # support
#     df_list[i][5].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_time.pkl") # time
...
def set_up_graph(model_name,rotulated,iteration):
    ...
    # with open('/home/vitor_vasconcelos/workdir/mestrado_v3/processed_datasets/'+dataset_name+'/fake_Y/fake_Y_'+str(rotulated)+'_'+str(iteration)+'.pkl', 'rb') as f:
    with open('/home/vitor_vasconcelos/workdir/mestrado_v3/'+output_datasets+'/'+dataset_name+'/new_masks_and_y_'+str(sample_size)+'/mask_rot'+str(rotulated)+'_'+str(iteration)+'.pkl', 'rb') as f:
        aux =  pickle.load(f)
        fake_y = aux[3]
...
for i in range(10):
    aux_list = []
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_acc.pkl")) # acuracia
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_pre.pkl")) # precision
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_rec.pkl")) # recall
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_f1.pkl"))  # f1-score
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_sup.pkl")) # support
    aux_list.append(pd.read_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(i)+"/df_time.pkl")) # time
    df_list.append(aux_list)
    ...
    for keyphrase in keyphrases:
        for rotulated in n_rotulated:
            for iteration in iterations:
                ...
                df_list[iteration][0].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_acc.pkl") # acuracia
                df_list[iteration][1].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_pre.pkl") # precision
                df_list[iteration][2].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_rec.pkl") # recall
                df_list[iteration][3].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_f1.pkl")  # f1-score
                df_list[iteration][4].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_sup.pkl") # support
                df_list[iteration][5].to_pickle("/home/vitor_vasconcelos/workdir/mestrado_v3/dataframes_"+str(sample_size)+"/"+str(iteration)+"/df_time.pkl") # support
